...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "delivery_method", "payment_method", "payment_status", "paid_at", "is_bespoke",
            "placed_at", "total_price", "notes", "items",
        ]
        read_only_fields = [
            "order_number", "placed_at", "delivery_method", "total_price", "payment_status", "paid_at",
        ]
